...
namespace DatingApp.API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            var otherUser = httpContex.Request.Query["user"].ToString();
        ...
        private async Task<Group> RemoveFromMessageGroup()
        {
            ...
            var conncetion = group.Connections.FirstOrDefault(x => x.ConnectionId == Context.ConnectionId);
            _unitOfWork.MessageRepository.RemoveConnection(conncetion);
